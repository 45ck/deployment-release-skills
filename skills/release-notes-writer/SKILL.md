...
purpose: "Write release notes that clearly communicate included changes, impacts, known issues, actions for users, and support expectations."
inputs: ["release scope", "user-facing changes", "technical changes", "known issues", "support/contact info"]
outputs: ["release notes", "impact summary", "upgrade actions", "known limitations", "support guidance"]
handoffs: ["runbook-writer", "post-release-monitoring-plan", "go-live-readiness-reviewer"]
---
# release-notes-writer

## Purpose
Write release notes that clearly communicate included changes, impacts, known issues, actions for users, and support expectations.
