---
name: "uat-readiness-checker"
pack: "deployment-release-pack"
purpose: "Check whether a system is ready for UAT by validating environment stability, scope clarity, data readiness, and acceptance ownership."
inputs: ["uat objectives", "environment status", "test data status", "acceptance criteria", "stakeholder availability"]
outputs: ["uat readiness summary", "missing prerequisites", "data/access issues", "decision on start readiness", "recommended fixes"]
handoffs: ["go-live-readiness-reviewer", "release-cut-checker", "environment-promotion-checker"]
---
# uat-readiness-checker

## Purpose
Check whether a system is ready for UAT by validating environment stability, scope clarity, data readiness, and acceptance ownership.
