---
name: "release-cut-checker"
pack: "deployment-release-pack"
purpose: "Check whether a release candidate is coherent, versioned correctly, and complete enough to be cut from the current branch or build line."
inputs: ["release scope", "candidate build or branch details", "included changes", "known defects", "approval state"]
outputs: ["release cut assessment", "missing items", "versioning/checklist findings", "blocking defects", "recommended action"]
handoffs: ["go-live-readiness-reviewer", "release-notes-writer", "environment-promotion-checker"]
---
# release-cut-checker

## Purpose
Check whether a release candidate is coherent, versioned correctly, and complete enough to be cut from the current branch or build line.
...
## Expected inputs
- release scope
- candidate build or branch details
- included changes
- known defects
- approval state
