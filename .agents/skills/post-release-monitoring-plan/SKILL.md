...
purpose: "Plan what must be monitored immediately after release so regressions, incidents, and adoption problems are detected early."
inputs: ["critical user journeys", "service metrics/logs", "alert thresholds", "support window", "incident triggers"]
outputs: ["monitoring plan", "critical signals", "ownership/on-call mapping", "decision thresholds", "hypercare checklist"]
handoffs: ["deployment-risk-checker", "runbook-writer", "go-live-readiness-reviewer"]
---
# post-release-monitoring-plan

## Purpose
Plan what must be monitored immediately after release so regressions, incidents, and adoption problems are detected early.
